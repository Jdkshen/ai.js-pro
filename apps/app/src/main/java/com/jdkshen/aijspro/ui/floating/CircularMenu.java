...
import com.jdkshen.aijspro.autojs.record.GlobalActionRecorder;
...
public class CircularMenu implements Recorder.OnStateChangedListener, LayoutInspector.CaptureAvailableListener, OperationItemClickListener {
    ...
    void settings() {
        ...
        mSettingsDialog = new OperationDialogBuilder(mContext)
                ...
                .item(R.id.floating_menu_exit, R.drawable.ic_close_white_48dp, R.string.text_exit_floating_window)
                .bindItemClick(this)
