...
final class ImGuiWorkspaceDrawer extends DrawerLayout {
    ...
    private com.jdkshen.aijspro.theme.AppThemePalette mThemePalette;
     ...
     */
    void applyTheme(com.jdkshen.aijspro.theme.AppThemePalette palette) {
    ...
    private void applyThemeToViewGroup(ViewGroup group, com.jdkshen.aijspro.theme.AppThemePalette palette) {
