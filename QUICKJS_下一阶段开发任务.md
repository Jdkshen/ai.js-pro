...
2. 阅读并以当前文件为准：
   - `QUICKJS_ENGINE.md`
   - `autojs/src/main/java/com/stardust/autojs/engine/QuickJsHostBridge.java`
   - `autojs/src/main/java/com/stardust/autojs/engine/QuickJsJavaScriptEngine.java`
   - `autojs/src/main/cpp/quickjs_jni.cpp`
   - 对应的 Rhino API 实现
...
```text
app/src/main/assets/sample/脚本引擎/
├─ QuickJS App 测试.js
...
```powershell
.\autojs\src\main\cpp\build-quickjs.ps1 -Configuration Release
...
- 修改 `QUICKJS_ENGINE.md` 和 `项目说明.md`，文档只能写实际完成并验证的能力。
